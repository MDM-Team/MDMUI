    ...
    ! function ($) {
        ...
        $.adaptObject = function (element, defaults, option, template, plugin, pluginName) {
            ...
            return $this.each(function () {
                ...
                if (!data) {
                    el.data('fz.' + pluginName, (data = new plugin(this, $.extend({}, defaults, typeof option == 'object' && option), isFromTpl)
    ...
    (function (w, $, undefined) {
        ...
        var tap = function ($els) {
            return $els.each(function () {
                ...
                $el.bind("touchstart.fz.tap MSPointerDown.fz.tap", start).bind("touchmove.fz.tap MSPointerMove.fz.tap",
                    move).bind("touchend.fz.tap MSPointerUp.fz.tap", end).bind("click.fz.tap", end);
            });
        };
