define(function (require, exports, module) {
    ...
    !(function ($) {
        ...
        var Scooch = (function ($, Utils) {
            var defaults = {
                    dragRadius : 10, moveRadius : 20, animate : true, autoHideArrows : false, classPrefix : 'tmb-', classNames : {
                        outer : 'slide', inner : 'slide-inner', item : 'item', center : 'center', touch : 'has-touch', dragging : 'dragging', active : 'active', inactive : 'inactive', fluid : 'fluid'
                    }
                }
                , has = $.support;
            ...
            Scooch.prototype._getClass = function (id) {
                console.log(this.options.classPrefix + this.options.classNames[id]);
        ...
        $.fn.Slide = function (action, options) {
            var initOptions = $.extend({}, $.fn.Slide.defaults);
